...
if __name__ == '__main__':
    ...
    parser.add_argument("--vna_ip", help="specify vna ip address", default=VNAHOST)
    parser.add_argument("--data_dir", help="specify a directory to save the data in", default='sandbox')
    ...
    parser.add_argument("--target_len", type=float, help="specify a target cable length (in meters)", default=CABLE_LEN)
